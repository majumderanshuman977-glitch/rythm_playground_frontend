...
// useEffect(() => {
//   fetch(`http://localhost:5000/api/short-videos?classType=${classTypeId}`)
//     .then(res => res.json())
...
useEffect(() => {
  ...
  fetchVideos();
}, [categoryId]); // 👈 important dependency


  // useEffect(() => {
  //   const fetchVideos = async () => {
  //     try {
  //       const res = await fetch("http://localhost:5000/api/short-videos");
  //       const json = await res.json();
