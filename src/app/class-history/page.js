...
function classHistiry() {
  ...
  useEffect(() => {
    fetchHistory(activeTab === 1 ? "upcoming" : "completed");
  }, [activeTab]);
  ...
  return (
    <>
      <section className="account_details_main">
        <img
          className={
            sideMenuOpen ? "prof_lft_bg active_sidemenu" : "prof_lft_bg"
          }
        ...
        <div className="account_details_inner">
          ...
          <div
            className={
              sideMenuOpen
                ? "account_details_left active_sidemenu"
              ...
              <div className="account_details_nav">
                <ul>
                  ...
                  <li className="active_nav">
                    <Link href="/class-history">Class History</Link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="account_details_right">
            ...
            <div className="class_history_main">
              <ul className="tabs-block">
                ...
                <span ref={labelRef} className="tab-label" />
              </ul>
              ...
              {!loading &&
                classes.map((item) => (
                  <div
                    key={item.class_id}
                    className="class_history_main_all"
                  >
                    <div className="class_history_main_single">
                      <div className="class_history_main_single_top">
                        <h2>{item.title}</h2>
                        <h4>Instructor : {item.instructor.first_name} {item.instructor.last_name}</h4>
                        <p>{item.description}</p>
                      </div>

                      {item.can_join && item.meeting_link && (
                        <div className="gmeet_icon">
                          <Link href={item.meeting_link} target="_blank">
